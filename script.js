...
const config = {
    serverInfo: {
        ...
        serverName2: "souvlakismp.join-game.net", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
...
const getMinecraftOnlinePlayer = async () => {
     try {
        const apiUrl = `https://api.mcsrvstat.us/2/5.83.150.96:25016`;
