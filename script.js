...
const config = {
    serverInfo: {
        ...
        serverIp: "souvlakismp.join-game.net", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
